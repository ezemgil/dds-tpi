...
router.get(
  "/nominaciones_pelicula/:id_academia/:id_premio/:id_pelicula/:fecha_nominacion",
...
router.get(
  "/nominaciones_pelicula/fecha/:fecha_nominacion",
  nominacion_pelicula.getNominacionPeliculaByFecha()
);
router.post(
  "/nominaciones_pelicula",
...
router.put(
  "/nominaciones_pelicula/:id_academia/:id_premio/:id_pelicula/:fecha_nominacion",
  nominacion_pelicula.updateNominacionPelicula()
);
router.delete(
  "/nominaciones_pelicula/:id_academia/:id_premio/:id_pelicula/:fecha_nominacion",
