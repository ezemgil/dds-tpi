...
export const getCineastasByName = async (req, res, next) => {
    try {
        ...
        res.json(cineastas);
        log(req, `GET /cineastas?nombre=${req.query.nombre} ${cineastas.length} registros encontrados`);
    } catch (error) {
...
export const getCineastasAleatorios = async (req, res, next) => {
    try {
        ...
        res.json(cineastas);
        log(req, `GET /cineastas/aleatorios?cantidad=${req.query.cantidad} ${cineastas.length} registros encontrados`);
    } catch (error) {
