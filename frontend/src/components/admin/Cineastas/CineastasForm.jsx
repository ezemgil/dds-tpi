            ...
            <form className="form col-lg-12 col-md-12" action="" onSubmit={handleSubmit(onSubmit)}>
                <div className="container-fluid ">
                    ...
                    <div className="row">
                        ...
                        <div className="mb-3 col">
                            <label htmlFor="fecha_nacimiento" className="col-form-label">
                                Fecha Nacimiento
                            </label>
                            <input
                                type="date"
                        ...
                        <div className="mb-3 col">
                            <label htmlFor="fecha_fallecimiento" className="col-form-label">
                                Fecha Fallecimiento
                            </label>
                            <input
                                type="date"
                                ...
                                className={
                                    "bg-dark text-light border-secondary form-control" +
                                    (errors?.fecha_fallecimiento ? " is-invalid" : "")
                                }
                            />
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="ms-3 col">
                            {/* Campo nacionalidad*/}
                            <div className="mb-3">
                                <label className="mb-2" htmlFor="pais">
                                    Nacionalidad 1
                                </label>
                                <select
                                    name="pais"
                                ...
                                >
                                    {listaPaises?.map((p) => (
                                        <option key={p.id} value={p.id} selected={itemCineasta.pais?.id == p.id}>
                                            {p.nombre}
                                        </option>
                                    ))}
                                </select>
                            ...
                            <div>
                                <label className="mb-2" htmlFor="pais2">
                                    Nacionalidad 2
                                </label>
                                <select
                                    name="pais2"
                                ...
                                >
                                    <option selected={itemCineasta.pais2?.id == null} key={0} value={0}>
                                        Ninguno
                                    </option>
                                    {listaPaises?.map((p) => (
                                        <option selected={itemCineasta.pais2?.id == p.id} key={p.id} value={p.id}>
                                            {p.nombre}
                                        </option>
                                    ))}
                                </select>
