            ...
            <form className="form col-lg-12 col-md-12" action="" onSubmit={handleSubmit(onSubmit)}>
                <div className="container-fluid ">
                    ...
                    <div className="mb-3">
                        ...
                        <input
                            type="text"
                            className="mb-1 form-control bg-dark text-light border-secondary"
                            id="titulo"
                            name="titulo"
                    ...
                    <div className="mb-3">
                        ...
                        <input
                            ...
                            {...register("titulo_original", {
                                required: { value: true, message: "Titulo original es obligatorio" },
                            })}
                        />
                        {errors.titulo_original && (
                            <span className="text-danger">{errors.titulo_original.message}</span>
                        )}
                    </div>
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                {...register("fecha_estreno", {
                                    required: { value: true, message: "Fecha de estreno es obligatoria" },
                                })}
                                className={
                                    "mb-1 bg-dark text-light border-secondary form-control" +
                                    (errors?.fecha_estreno ? " is-invalid" : "")
                                }
                            />
                            {errors.fecha_estreno && (
                                <span className="text-danger">{errors.fecha_estreno.message}</span>
                            )}
                        </div>
                    </div>
